...
int SkEdge::setLine(const SkPoint& p0, const SkPoint& p1, const SkIRect* clip,
    ...
    {
        x0 = SkScalarToFDot6(p0.fX, shift);
        y0 = SkScalarToFDot6(p0.fY, shift);
        x1 = SkScalarToFDot6(p1.fX, shift);
        y1 = SkScalarToFDot6(p1.fY, shift);
    }
...
int SkQuadraticEdge::setQuadratic(const SkPoint pts[3], int shift)
{
    ...
    {
        x0 = SkScalarToFDot6(pts[0].fX, shift);
        y0 = SkScalarToFDot6(pts[0].fY, shift);
        x1 = SkScalarToFDot6(pts[1].fX, shift);
        y1 = SkScalarToFDot6(pts[1].fY, shift);
        x2 = SkScalarToFDot6(pts[2].fX, shift);
        y2 = SkScalarToFDot6(pts[2].fY, shift);
    }
...
int SkCubicEdge::setCubic(const SkPoint pts[4], const SkIRect* clip, int shift)
{
...

    {
        ...
        x2 = SkScalarToFDot6(pts[2].fX, shift);
        y2 = SkScalarToFDot6(pts[2].fY, shift);
        x3 = SkScalarToFDot6(pts[3].fX, shift);
        y3 = SkScalarToFDot6(pts[3].fY, shift);
    }
